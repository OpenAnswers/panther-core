...
- [Docker](https://docs.docker.com/engine/install/) 29.6
...
services:
  ...
  event-monitors-http:
    image: openanswers/panther-monitors:5
...
With the pre-built images there are two ways to send events to Panther, _Syslog_ and _HTTP_.
