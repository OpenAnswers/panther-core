  ...
  methods: {
    ...
    compare_inode: function( inode )
    {
      if( this.getTracker() == undefined )
        return false;
      if( this.getTracker().ino == undefined )
        return false;
    ...
    compare_size: function( size )
    {
      if( this.getTracker() == undefined )
        return false;
      if( this.getTracker().size == undefined )
        return false;
      return  this.getTracker().size == size;
    },
    compare_inode_and_size: function( inode, size )
    {
      if( this.compare_inode( inode ) )
        return this.compare_size( size );
      else
        return false;
    },
    write: function( stat )
    ...
    where_to_start_from: function( stat )
    {
      ...
      if( stat.size < this.getTracker().size )
        return stat.size;
      else
        return this.getTracker().size;
    }
  }
});
